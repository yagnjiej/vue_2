...
<script>
import chianaJson from '@/assets/data.json'
...
export default {
  ...
  mounted() {
    ...
    this.$echarts.registerMap('china', chianaJson)
    // 复制的代码
    console.log(chianaJson);
    let name_title = "中国人民大学2020年各省市计划录取人数"
    let subname = '上海、浙江无文理科录取人数'
